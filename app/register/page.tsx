...
import { Box, Lock, Mail, User, Eye, EyeOff, AlertCircle, CheckCircle2 } from "lucide-react";
    ...
    try {
      ...
      if (res.success) {
        if (res.needsEmailVerification) {
          setSuccessMessage("Registrasi berhasil. Silakan cek email Anda untuk melakukan verifikasi.");
        } else {
    ...
    <div className="min-h-screen bg-[#F8FAFC] text-[#172033] font-sans antialiased flex flex-col justify-center items-center p-4 sm:p-6">
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="bg-white border border-[#E7EBF0] rounded-xl p-6 sm:p-8 shadow-xs space-y-5">
          ...
          {successMessage && (
            <div className="p-3 bg-[#E8F7F1] border border-[#087F5B]/30 rounded-lg text-[#087F5B] text-xs font-semibold flex items-start gap-2">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Contoh: Ramsa Airil"
